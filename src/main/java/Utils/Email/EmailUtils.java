...
public class EmailUtils {
    ...
    private static final String propertiesFullPath = "";
    ...
    public EmailUtils(String username, String password, String server,
                      EmailFolder emailFolder, Properties props, String protocol) throws MessagingException {

        Session session = Session.getDefaultInstance(props);
        Store store = session.getStore(protocol);//imaps
